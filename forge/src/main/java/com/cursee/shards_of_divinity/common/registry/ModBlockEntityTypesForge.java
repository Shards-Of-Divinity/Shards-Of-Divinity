...
public class ModBlockEntityTypesForge {
    ...
    public static final RegistryObject<BlockEntityType<SmoulderingAntiquatedLogBlockEntity>> SMOULDERING_ANTIQUATED_LOG_BLOCK_ENTITY =
            RegistryForge.registerBlockEntityType("smouldering_antiquated_log", () -> BlockEntityType.Builder.of(SmoulderingAntiquatedLogBlockEntity::new, ModBlocksForge.SMOULDERING_ANTIQUATED_LOG.get()).build(null));
}
